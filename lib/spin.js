...
exports.for = function (API) {
	...
	var Program = function (API, options) {
		...
		API.console.debug("Run program '" + self.label + "':", API.getTargetPath());
...
//console.log("declaringDescriptor", declaringDescriptor);
				...
				API.console.debug("Run commands:", options.commands, {
            		cwd: options.cwd
            	});
			    ...
			    self.process.stdin.write(options.commands.join("\n"));
